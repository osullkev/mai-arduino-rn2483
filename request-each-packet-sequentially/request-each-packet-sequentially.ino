...
void requestFirmwareUpdatePacketIndex(){  
  transmitMessage("4", padWithZeros(String(currentUpdateIndex, HEX), 4), true);  
}
...
char handleUpdatePacket() 
{
  ...
  {
    Serial.println(F("Firmware Update Packet Received... Moving onto next packet"));
...
//  String data =   myLora.getRx().substring(4);
...
//  String command = ack ? "mac tx cnf 1 " : "mac tx uncnf 1 ";
  ...
  ////////////////////////////////////////////////////////
  //////     Comment below to simulate LoRa RX     ///////
  ////////////////////////////////////////////////////////
